        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="your-order-area">
                    ...
                    <div class="your-order-wrap gray-bg-4">
                        <form action="{{ route('seller.cash.order') }}" method="post" id="payment-form">
                            @csrf
                            ...
                            <input type="hidden" name="collectcash_amount" value="{{ $data['collectcash_amount'] }}">
                            <input type="hidden" name="hdmargin_amount" value="{{ $data['margin_amount'] }}">
                            ...
                            <div class="your-order-info-wrap">
                                ...
                                @if ($cart_true == 1)
                                    ...
                                    <div class="your-order-info order-shipping">
                                        <ul>
                                            <li>Your Margin <p> <span>₹{{ $margin_amount }}</span></p>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                @else
                                    ...
                                    <div class="your-order-info order-shipping">
                                        <ul>
                                            ...
                                            <li>Your Margin <p> <span>₹{{ round($margin_amount) }}</span></p>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <input type="hidden" name="buy_now_total" id="buy_now_total"
                                        value="{{ round($buy_total - ($coupon_discount * $buy_price) / 100) + $margin_amount }}">
                                    <div class="your-order-info order-total">
                                        <ul>
                                            <li>Total <span id="total"
                                                    name="total">₹{{ round($buy_total - ($coupon_discount * $buy_price) / 100) + $margin_amount }}
                                                </span></li>
                                        </ul>
                                    </div>
                                @endif
            ...
            <div class="col-lg-8 col-md-8">
                ...
                <div class="d-flex justify-content-center align-items-center mt-20 float-right">
                    <button type="submit" class="btn btn-flat btn-dark submitBtn" title="Add to Cart">Confirm
                        Order</button>
                </div>
                </form>
            </div>
