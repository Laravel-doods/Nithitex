                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="billing-info mb-20">
                                        ...
                                        <input type="text" value="{{ Auth::user()->phone }}" name="shipping_phone"
                                ...
                                <div class="col-lg-12">
                                    <div class="billing-info mb-20">
                                        ...
                                        <input class="billing-address" value="{{ Auth::user()->door_no }}"
                                            name="door_no" id="door_no"
                                            placeholder="Enter Door No. / Flat No. / Floor No." type="text"
                                ...
                                <div class="col-lg-12">
                                    <div class="billing-info mb-20">
                                        ...
                                        <input class="billing-address" name="street_address" id="street_address"
                                            ...
                                            value="{{ Auth::user()->street_address }}" type="text" required=""
                                            autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="billing-info mb-20">
                                        ...
                                        <input class="billing-address" name="city_name" id="city_name"
                                            ...
                                            value="{{ Auth::user()->city_name }}" required="" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="billing-info mb-20">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="billing-info mb-20">
                                        ...
                                        <input type="text" name="pin_code" id="pin_code"
                                            value="{{ Auth::user()->pin_code }}" required=""
                    ...
                    <div class="col-lg-5">
                        <div class="your-order-area">
                                    ...
                                    @else
                                        ...
                                        <div class="your-order-info order-total">
                                            <ul>
                                                ...
                                                <li>Total <span id="total"
                                                        name="total">₹{{ round($buynow_price) }} </span></li>
                                            </ul>
                                        </div>
                                    @endif
                            ...
                            <div class="Place-order">
                                <button type="submit" class="btn btn-flat btn-dark" title="Place Order" disabled
