                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4" style="float-right;">
                                            ...
                                            <h5><span style="color: green;">Subtotal:</span><span
                                                    style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{ round($order->sub_total) }}
                                            </h5>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4" style="float:right;">
                                            @if ($order->status != 'cancelled')
                                                @if ($order->status != 'delivered' && $order->status != 'returned')
                                                    ...
                                                    @endphp
                                                    @if ($orders)
                                                        <form action="{{ route('alll.cancel.request', $order->id) }}"
                                                            method="post">
                                                            @csrf
                                                ...
                                                @else
                                                    ...
                                                    @if ($Retorder)
                                                        <form action=" {{ route('return.order', $order->id) }}"
                                                            method="post">
                                                            @csrf

                                                            <div class="form-group">
                                                                <b> Order Return Reason:</b>
                                                                <textarea name="return_reason" id="Return Reason" class="form-control" cols="30" rows="05" maxlength="255"
                                                                    required></textarea>
                                                            </div><br>
