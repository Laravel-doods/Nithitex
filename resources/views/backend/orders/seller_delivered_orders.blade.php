...
<div class="page-content">
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h5>Reseller Delivered Order List </h5>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                <li class="breadcrumb-item active">Master</li>
                <li class="breadcrumb-item active">Reseller Delivered Order List</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table id="tblSellerDeliverdOrder" class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Order Date</th>
...
<script src="{{ asset('backend/assets/js/Reseller_order/seller_deliverd_order.js?v=2') }}"></script>